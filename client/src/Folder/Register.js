      ...
      <Form className="container-fluid">
        ...
        <div className="row ">
          <div className="col-lg-8 col-md-8 col-sm-12 ">
            <label for="name">
              Full Name <sup className="bi bi-star-fill text-danger"></sup>
            </label>
            <br />
            <input
          ...
          <div className="col-lg-4 col-md-4 col-sm-12">
            <label for="">
              Gender <sup className="bi bi-star-fill text-danger"></sup>
            </label>
            <br />
          ...
          <div className="row ">
            <div className="col-lg-4 col-md-6 col-sm-12">
              <label for="dob">
                Date of Birth{" "}
                <sup className="bi bi-star-fill text-danger"></sup>
              </label>
              <br />
              <input
                type="date"
            ...
            <div className="col-lg-4 col-md-12 col-sm-12">
              <label for="aadharNo">Aadhaar Card No. </label>
              <br />
              <input
                className="form-control"
                type="number"
          ...
          <div className="row ">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              <label for="mobileNo">
                Mobile No. <sup className="bi bi-star-fill text-danger"></sup>
              </label>
              <input
                className="form-control"
                type="tel"
